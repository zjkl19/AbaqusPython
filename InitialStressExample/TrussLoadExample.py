...
myModel.StaticStep(name='loadStep', previous='InitialStep',
...
cLoad=1.0
v=trussInstance2.vertices
verts=v.findAt(((0.0, l2, 0.0), ),)
myAssembly.Set(vertices=verts, name='Set-force')

region=myAssembly.sets['Set-force']

myModel.ConcentratedForce(name='centerLoad', createStepName='loadStep',
    region=region, cf1=1.0*cLoad, distributionType=UNIFORM, field='',
    localCsys=None)
#-------------------------------------------------------

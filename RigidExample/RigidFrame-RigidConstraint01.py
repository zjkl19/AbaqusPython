...
#summary:compare to "RigidFrame-RigidConstraint.py", mod rigid part properties
#structure:frame
...
modelName='RigidFrame-RigidConstraint01'
...
myModel.BeamSection(name='RectSection-mod', integration=BEFORE_ANALYSIS,
	poissonRatio=0.28, beamShape=CONSTANT, profile='RectProfile', thermalExpansion=OFF,
	temperatureDependency=OFF, dependencies=0, table=((2.10e2, 8.203e2), ),
	alphaDamping=0.0,betaDamping=0.0, compositeDamping=0.0, centroid=(0.0, 0.0), 
	shearCenter=(0.0, 0.0),	consistentMassMatrix=False)
...
beamPart.SectionAssignment(region=beamRegion, sectionName='RectSection-mod',
    offset=0.0, offsetField='',offsetType=MIDDLE_SURFACE,
	thicknessAssignment=FROM_SECTION)

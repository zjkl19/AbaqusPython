...
myModel.GeneralizedProfile(name='beamProfile', area=3.24, i11=0.153819, i12=0.264036, i22=21.7272, j=0.0, gammaO=0.0, gammaW=0.0) 
...
myModel.StaticStep(name='Step-Gravity', previous='Initial',
    minInc=0.001, initialInc=0.2, description='Load of the Gravity.')

myModel.StaticStep(name='beamStep', previous='Step-Gravity',
